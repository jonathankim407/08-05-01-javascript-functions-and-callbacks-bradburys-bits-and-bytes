...
*/
var numSales = transactions.filter(onlySales).length;

function onlySales(transaction) {
...
var numPurchases = transactions.filter(onlyPurchases).length;

function onlyPurchases(transaction) {
...
*/
var numCashSales = transactions.filter(onlyCashSales).length;

function onlyCashSales(transaction) {
...
*/
var numCreditPurchases = transactions.filter(onlyCreditPurchases).length;

function onlyCreditPurchases(transaction) {
...
*/
var uniqueVendors = transactions.filter(onlyVendors).map(onlyVendors);

function onlyVendors(transaction){
...
*/
var bigSpenders = transactions.filter(saleFiveOrMoreItems).map(saleFiveOrMoreItems);

function saleFiveOrMoreItems(transaction) {
